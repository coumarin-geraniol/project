                            ...
                            <div class="d-flex justify-content-center p-2 ">
                                <div class="panel-content" data-select2-id="36">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('kayit') }}" name="kayit" type="text" id="simpleinput" class="form-control">
                                        @error('kayit')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('reason') }}" name="reason" type="text" id="simpleinput" class="form-control">
                                        @error('reason')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
